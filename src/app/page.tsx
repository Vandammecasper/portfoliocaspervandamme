        ...
        <div className="-mt-6 md:-mt-7 lg:-mt-8 bg-sky-500 h-4 sm:h-6 md:h-8 lg:h-10 flex items-center pl-80 sm:pl-96 md:pl-100 2xl:pl-110 gap-96 sm:gap-100 pr-96">
          <div className='flex flex-col items-center'>
            <button onClick={() => setPol(!pol)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${pol ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs transition ease-in-out delay-150 duration-300 whitespace-nowrap -mt-4 sm:-mt-3 md:-mt-2.5 lg:-mt-3 mb-2 sm:mb-0.5 lg:mb-0.5 ${pol ? 'opacity-100 scale-15 sm:scale-25 md:scale-30' : 'opacity-0'}`}>OCT 2024</p>
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-14 sm:-mt-14 md:-mt-12 lg:-mt-14 ${pol ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>On Monday, October 21st, I began my professional journey at Polysense, a young and innovative startup that leverages AI to help manufacturing companies optimize their processes for greater efficiency and sustainability. As a full-stack developer at Polysense, I am responsible for developing and maintaining the UI. </p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setGrad(!grad)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${grad ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-13 sm:-mt-13 md:-mt-11 lg:-mt-12 ${grad ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>After three years of hard work, I am proud to have graduated from Howest. This achievement marks an important milestone, and I am excited to explore new opportunities. I am currently seeking my first job to apply my skills and knowledge while starting the next chapter of my career.</p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setThesis(!thesis)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${thesis ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-40 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-14 sm:-mt-13 md:-mt-12 lg:-mt-13 ${thesis ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>For my bachelor’s thesis, I studied how a website's interface can adapt to the emotions of the user using the Skybiometry API. I created four interfaces—happy, neutral, sad, and angry—based on detected emotions, with sections on research, development, reflections, and recommendations.</p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setInternship(!internship)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${internship ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-9 sm:-mt-9 md:-mt-8 ${internship ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>During my final semester, I completed a 14-week internship at Sweet Mustard as a front-end developer for Project Hello, a system that notifies hosts when visitors check in and collects feedback after meetings.</p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setHaxx(!haxx)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${haxx ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-13 sm:-mt-13 md:-mt-11 lg:-mt-12 ${haxx ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>Haxx, my industry project in the fourth semester, was developed with classmates for Axxes. We created a conference tool with a website and app, allowing employees to view the calendar, sign up for events, and, during the conference, use the app as a guide to track their schedule and events.</p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setDokemaca(!dokemaca)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${dokemaca ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-40 sm:w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-13 sm:-mt-11 md:-mt-10 lg:-mt-11 ${dokemaca ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>Dokemaca, my first team project for Howest's Bruges campus, features six interactive poles with buttons and lights, encouraging physical activity through game modes like "time attack" and "Simon says," where participants tap the lit-up poles and compare scores.</p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setCashCar(!cashCar)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${cashCar ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-40 sm:w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-13 sm:-mt-11 md:-mt-10 lg:-mt-11 ${cashCar ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>Cash Car, my first project at MCT, helps a group of students share travel costs by calculating each passenger's payment based on distance, fuel prices, and the number of passengers, using RFID tags for check-ins and offering real-time trip monitoring and history.</p>
            </button>
          ...
          <div className='flex flex-col items-center'>
            <button onClick={() => setHowest(!howest)} className={`mt-18 sm:mt-22 md:mt-25 lg:mt-27 bg-slate-900 border-sky-500 rounded-full w-8 sm:w-12 md:w-16 lg:w-20 h-8 sm:h-12 md:h-16 lg:h-20 flex flex-col items-center transition ease-in-out delay-100 duration-300 ${howest ? 'scale-1000 sm:scale-800 md:scale-500 border-1' : 'scale-100 border-4'}`}>
              ...
              <p className={`text-slate-200 text-center font-inter text-xxs lg:text-xs w-40 sm:w-44 lg:w-56 transition ease-in-out delay-150 duration-300 -mt-11 sm:-mt-11 md:-mt-9 lg:-mt-9 ${howest ? 'opacity-100 scale-15 sm:scale-20 md:scale-30' : 'opacity-0'}`}>After high school, I wanted to pursue my passion for websites, and applications, so I searched for a development program. When I found the course and campus at Howest, I was immediately sold and started my next chapter in Kortrijk.</p>
            </button>
