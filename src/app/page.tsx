...
export default async function Page () {
    return(
        <main className="">
            <div className="w-screen h-screen bg-slate-900 sm:h-90% flex flex-col items-center justify-center sm:grid lg:grid-rows-2 lg:grid-flow-col lg:gap-80 sm:justify-items-center lg:pt-28">
