        ...
        <main className="bg-slate-900 min-h-screen">
            <div className="w-screen flex flex-col md:flex-row justify-between pt-32 md:pt-48">
                ...
                <div className="row-span-2 xl:mt-10 md:w-7/12 sm:p-10 xl:p-0">
                    ...
                    <h2 className={`lg:text-xl font-medium text-slate-700 pt-0 3xl:text-2xl xl:pt-3 pl-6  transition-all duration-2500`}>Front-end- or full-stack development</h2>
                    <h3 className={`text-slate-200 pt-3 pl-6 pr-5 3xl:text-xl  transition-all duration-2500`}>I love working on websites and apps. besides development I also like working on the design!</h3>
                    <h3 className={`text-slate-200 pt-2 pl-6 pr-5 3xl:text-xl  transition-all duration-2500`}>Do you wish to get in touch with me? Feel free to send me an email!</h3>
                    <Email/>
                </div>
                <div className="hidden md:block md:row-span-2 md:w-96 3xl:hidden">
                    <Logo/>
                </div>
