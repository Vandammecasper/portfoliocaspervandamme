...
export default function Page () {
    ...
    return(
        <main className="overflow-hidden">
            <div className="block xl:grid xl:grid-rows-2 xl:grid-flow-col pt-6 pb-20 lg:pb-0 lg:pt-12 xl:pt-16 gap-24 overflow-auto">
                ...
                <div className="hidden lg:block xl:hidden pb-16">
                    <h1 className="text-4xl font-medium text-sky-500 pl-10 xl:hidden block pb-6 pt-8 xl:pt-0">history()</h1>
