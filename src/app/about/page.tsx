...
export default function Page () {
    return(
        <main className="overflow-hidden h-screen">
            <div className="block xl:grid xl:grid-rows-2 xl:grid-flow-col pt-6 lg:pt-12 xl:pt-16 gap-24 overflow-auto w-full h-screen">
                <div className="xl:row-span-2 pl-2 xl:pl-12 xl:pb-20 xl:w-full">
                        ...
                        <h2 className="text-base xl:text-lg text-slate-200 pl-8 pt-2 xl:pt-5 pb-0 xl:pb-4">In the second year (semester 3) the students have to make a choice for a sub-direction. During the course of the first 3 semesters and the several projects, I learned that my preference lies in design and front-end development. The choice for the sub-direction 'Next web developer' was obvious. I recently graduated with my bachelor's degree and am currently looking for my first job in front-end development or full-stack development, where i can apply my skills and continue to grow in the field.</h2>
                </div>
                <div>
                    <h1 className="text-4xl font-medium text-sky-500 pl-8 xl:pt-0 pt-8">skills()</h1>
                    <div className="w-5/6 grid col-auto">
